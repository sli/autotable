...
var $sli$autotable$Autotable$init = F2(
...
var $sli$autotable$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			tableState: A2($sli$autotable$Autotable$init, $sli$autotable$Main$columns, $sli$autotable$Main$data)
		},
		$elm$core$Platform$Cmd$none);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$rem(10.0),
