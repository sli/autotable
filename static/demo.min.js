...
var $sli$autotable$Autotable$Column = F7(
	function (label, key, render, editRender, sort, filter, update) {
		return {editRender: editRender, filter: filter, key: key, label: label, render: render, sort: sort, update: update};
	});
var $sli$autotable$Main$Edit = F3(
	function (a, b, c) {
		return {$: 'Edit', a: a, b: b, c: c};
	});
var $sli$autotable$Main$numberFilter = F3(
	function (fn, d, s) {
		return A2(
...
var $sli$autotable$Main$numberSort = F2(
	function (fn, d) {
		return $elm$core$String$fromInt(
			fn(d));
	});
var $elm$core$String$toLower = _String_toLower;
var $sli$autotable$Main$stringFilter = F3(
	function (fn, d, s) {
		var ls = $elm$core$String$toLower(s);
		return A2(
			$elm$core$String$startsWith,
			ls,
...
var $sli$autotable$Main$columns = _List_fromArray(
	[
		A7(
		$sli$autotable$Autotable$Column,
		'Name',
		'name',
		function ($) {
			return $.name;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onInput(
							A2($sli$autotable$Main$Edit, 'name', i))
						]),
					_List_Nil);
			}),
		function ($) {
		...
		$sli$autotable$Main$stringFilter(
			function ($) {
				return $.name;
			}),
		F2(
		...
		'age',
		function (p) {
			return $elm$core$String$fromInt(p.age);
		},
		F2(
			function (p, i) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Attributes$value(
							$elm$core$String$fromInt(p.age)),
							$elm$html$Html$Events$onInput(
							A2($sli$autotable$Main$Edit, 'age', i))
						]),
					_List_Nil);
			}),
		$sli$autotable$Main$numberSort(
			function ($) {
				return $.age;
			}),
		$sli$autotable$Main$numberFilter(
			function ($) {
				return $.age;
			}),
		F2(
			function (r, v) {
				var _v0 = $elm$core$String$toInt(v);
				if (_v0.$ === 'Just') {
					var age = _v0.a;
					return _Utils_update(
						r,
		...
		'cats',
		function (p) {
			return $elm$core$String$fromInt(p.cats);
		},
		F2(
			function (p, i) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Attributes$value(
							$elm$core$String$fromInt(p.cats)),
							$elm$html$Html$Events$onInput(
							A2($sli$autotable$Main$Edit, 'cats', i))
						]),
					_List_Nil);
			}),
		$sli$autotable$Main$numberSort(
...
var $sli$autotable$Main$Person = F3(
	function (name, age, cats) {
		return {age: age, cats: cats, name: name};
	});
var $sli$autotable$Main$data = _List_fromArray(
	[
		A3($sli$autotable$Main$Person, 'Bob', 30, 2),
		A3($sli$autotable$Main$Person, 'Jack', 30, 1),
		A3($sli$autotable$Main$Person, 'Jane', 31, 2),
		A3($sli$autotable$Main$Person, 'William', 31, 3),
		A3($sli$autotable$Main$Person, 'Jolene', 32, 3),
		A3($sli$autotable$Main$Person, 'Billy', 43, 5),
		A3($sli$autotable$Main$Person, 'Holly', 32, 1),
		A3($sli$autotable$Main$Person, 'Xavier', 33, 1),
		A3($sli$autotable$Main$Person, 'Jimmy', 35, 0),
		A3($sli$autotable$Main$Person, 'John', 34, 0),
		A3($sli$autotable$Main$Person, 'Ashley', 34, 1),
		A3($sli$autotable$Main$Person, 'Michael', 34, 1),
		A3($sli$autotable$Main$Person, 'Eva', 34, 1),
		A3($sli$autotable$Main$Person, 'Claire', 34, 1),
		A3($sli$autotable$Main$Person, 'Lindsay', 34, 1)
	]);
var $sli$autotable$Autotable$init = F3(
	function (columns, data, pageSize) {
		return {
			columns: columns,
...
var $sli$autotable$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			tableState: A3($sli$autotable$Autotable$init, $sli$autotable$Main$columns, $sli$autotable$Main$data, 5)
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $sli$autotable$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $sli$autotable$Autotable$Edit = F3(
	function (a, b, c) {
		return {$: 'Edit', a: a, b: b, c: c};
	});
...
var $sli$autotable$Autotable$findColumn = F2(
	function (columns, key) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (c) {
					return _Utils_eq(c.key, key);
				},
				columns));
	});
var $sli$autotable$Autotable$None = {$: 'None'};
var $sli$autotable$Autotable$findSorting = F2(
	function (sorting, key) {
		var _v0 = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (s) {
					return _Utils_eq(s.a, key);
				},
				sorting));
		if (_v0.$ === 'Just') {
			var s = _v0.a;
			...
			return $sli$autotable$Autotable$None;
		}
	});
var $sli$autotable$Autotable$indexForColumn = F2(
...
var $sli$autotable$Autotable$listInsert = F3(
	function (data, index, item) {
		return $elm$core$List$concat(
			_List_fromArray(
				[
					A2($elm$core$List$take, index, data),
					_List_fromArray(
					[item]),
					A2($elm$core$List$drop, index, data)
				]));
	});
...
var $sli$autotable$Autotable$Asc = {$: 'Asc'};
var $sli$autotable$Autotable$Desc = {$: 'Desc'};
var $sli$autotable$Autotable$stepDirection = function (direction) {
	switch (direction.$) {
		case 'Asc':
			return $sli$autotable$Autotable$Desc;
		case 'Desc':
			return $sli$autotable$Autotable$None;
		default:
			return $sli$autotable$Autotable$Asc;
	}
};
var $sli$autotable$Autotable$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Sort':
				var key = msg.a;
				var dir = $sli$autotable$Autotable$stepDirection(
					A2($sli$autotable$Autotable$findSorting, model.sorting, key));
			...
			case 'DragStart':
				...
				return _Utils_update(
					model,
					{
						dragging: $elm$core$Maybe$Just(target)
					});
			case 'DragEnd':
				return _Utils_update(
					model,
			...
			case 'DragOver':
				var target = msg.a;
				var _v3 = A2($sli$autotable$Autotable$indexForColumn, target, model.columns);
				if (_v3.$ === 'Just') {
					var targetPosition = _v3.a;
						...
						if (!_Utils_eq(key, target)) {
							...
							if (_v5.$ === 'Just') {
								...
								var cleaned = A2(
									...
									model.columns);
								var columns = A3($sli$autotable$Autotable$listInsert, cleaned, targetPosition, column);
								return _Utils_update(
									model,
									{columns: columns});
							} else {
			...
			case 'ToggleEdit':
				...
				if (_v6.$ === 'Just') {
					...
					return _Utils_update(
						model,
						{
							editing: A2($elm$core$List$cons, index, model.editing)
						});
				}
			case 'Edit':
				var key = msg.a;
				var index = msg.b;
				var value = msg.c;
				var _v7 = A2($sli$autotable$Autotable$findColumn, model.columns, key);
				if (_v7.$ === 'Just') {
					var column = _v7.a;
					var _v8 = A2($elm$core$Array$get, index, model.data);
					if (_v8.$ === 'Just') {
						var r = _v8.a;
						var row = A2(column.update, r, value);
						return _Utils_update(
							model,
							{
								data: A3($elm$core$Array$set, index, row, model.data)
							});
					} else {
						return model;
					}
			...
			case 'NextPage':
				return _Utils_update(
					...
					{page: model.page + 1});
			default:
				var page = A2($elm$core$Basics$max, 1, model.page - 1);
				return _Utils_update(
					model,
					{page: page});
		}
	});
var $sli$autotable$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'TableMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tableState: A2($sli$autotable$Autotable$update, tableMsg, model.tableState)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var key = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							tableState: A2(
								$sli$autotable$Autotable$update,
								A3($sli$autotable$Autotable$Edit, key, index, value),
								model.tableState)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $sli$autotable$Main$TableMsg = function (a) {
	return {$: 'TableMsg', a: a};
};
...
var $sli$autotable$PageCss$pageCss = $rtfeldman$elm_css$Html$Styled$toUnstyled(
			...
			[
				...
				_List_fromArray(
					[
						...
						A4($rtfeldman$elm_css$Css$rgba, 190, 190, 190, 0.25)),
						$rtfeldman$elm_css$Css$marginTop(
						$rtfeldman$elm_css$Css$rem(2.0)),
						$rtfeldman$elm_css$Css$width(
						$rtfeldman$elm_css$Css$pct(100))
					])),
				A2(
				$rtfeldman$elm_css$Css$Global$selector,
				'div.autotable__pagination',
				_List_fromArray(
					[
				...
				A2(
				$rtfeldman$elm_css$Css$Global$selector,
				'div.autotable__pagination-page',
				_List_fromArray(
					[
						A3(
							...
							[
								...
								_List_fromArray(
									[
										...
										A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.035))
									])),
								$rtfeldman$elm_css$Css$Global$tr(
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$borderBottom(
												$rtfeldman$elm_css$Css$px(0))
											]))
									]))
							]))
				...
				A2(
				$rtfeldman$elm_css$Css$Global$selector,
				'table.autotable tr.filter-inputs th > input',
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$borderRadius(
				...
				A2(
				$rtfeldman$elm_css$Css$Global$selector,
				'table.autotable tbody tr td:not(.editing)',
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$padding(
...
var $sli$autotable$Autotable$setOrder = F2(
...
var $sli$autotable$Autotable$sorter = F4(
	function (sortFn, data, a, b) {
		var cb = function () {
			var _v1 = A2($elm$core$Array$get, b, data);
			if (_v1.$ === 'Just') {
				var r = _v1.a;
				return sortFn(r);
			} else {
		...
		var ca = function () {
			var _v0 = A2($elm$core$Array$get, a, data);
			if (_v0.$ === 'Just') {
				var r = _v0.a;
				return sortFn(r);
			} else {
		...
		return A2($elm$core$Basics$compare, ca, cb);
	});
var $elm$html$Html$table = _VirtualDom_node('table');
var $elm$html$Html$tbody = _VirtualDom_node('tbody');
var $elm$html$Html$thead = _VirtualDom_node('thead');
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $sli$autotable$Autotable$ToggleEdit = function (a) {
	return {$: 'ToggleEdit', a: a};
};
var $sli$autotable$Autotable$listContains = F2(
	function (item, list) {
		var _v0 = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
...
var $sli$autotable$Autotable$viewDisplayRow = F2(
	function (column, row) {
		return A2(
			$elm$html$Html$td,
			_List_fromArray(
...
var $sli$autotable$Autotable$viewEditRow = F3(
	function (column, row, index) {
		return A2(
			$elm$html$Html$td,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('text-left editing')
				]),
			_List_fromArray(
				[
					A2(column.editRender, row, index)
				]));
	});
var $sli$autotable$Autotable$viewBodyRows = F3(
	function (model, indexes, toMsg) {
		var rows = A2(
			$elm$core$List$filterMap,
			function (i) {
				return A2($elm$core$Array$get, i, model.data);
			},
			indexes);
		var buildRow = F2(
			function (index, row) {
				return A2(
					...
					_Utils_ap(
						A2(
							$elm$core$List$map,
							function (c) {
								return A2($sli$autotable$Autotable$listContains, index, model.editing) ? A3($sli$autotable$Autotable$viewEditRow, c, row, index) : A2($sli$autotable$Autotable$viewDisplayRow, c, row);
							},
							model.columns),
						_List_fromArray(
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												toMsg(
													$sli$autotable$Autotable$ToggleEdit(index)))
											]),
										_List_fromArray(
											[
		...
		return A2($elm$core$List$indexedMap, buildRow, rows);
	});
var $sli$autotable$Autotable$Filter = F2(
	function (a, b) {
		return {$: 'Filter', a: a, b: b};
	});
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $elm$html$Html$th = _VirtualDom_node('th');
var $sli$autotable$Autotable$viewFilterCells = F2(
		...
		var filterCells = A2(
			...
			function (c) {
				var inputHandler = function (s) {
					return toMsg(
						A2($sli$autotable$Autotable$Filter, c.key, s));
				};
				return A2(
					$elm$html$Html$th,
					_List_Nil,
...
var $sli$autotable$Autotable$DragEnd = {$: 'DragEnd'};
var $sli$autotable$Autotable$DragOver = function (a) {
	return {$: 'DragOver', a: a};
};
var $sli$autotable$Autotable$DragStart = function (a) {
	return {$: 'DragStart', a: a};
};
var $sli$autotable$Autotable$Sort = function (a) {
	return {$: 'Sort', a: a};
};
var $elm$html$Html$Attributes$draggable = _VirtualDom_attribute('draggable');
var $sli$autotable$Autotable$onDragEnd = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'dragend',
		$elm$json$Json$Decode$succeed(msg));
};
var $sli$autotable$Autotable$onDragOver = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'dragover',
		$elm$json$Json$Decode$succeed(msg));
};
var $sli$autotable$Autotable$onDragStart = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'dragstart',
		$elm$json$Json$Decode$succeed(msg));
};
var $sli$autotable$Autotable$viewDirection = function (direction) {
	switch (direction.$) {
		case 'Asc':
			return '▲';
		case 'Desc':
...
var $sli$autotable$Autotable$viewHeaderCells = F2(
	function (model, toMsg) {
		var headerCells = A2(
			$elm$core$List$map,
			function (c) {
				var sorting = $sli$autotable$Autotable$viewDirection(
					A2($sli$autotable$Autotable$findSorting, model.sorting, c.key));
				return A2(
					$elm$html$Html$th,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							toMsg(
								$sli$autotable$Autotable$Sort(c.key))),
							$sli$autotable$Autotable$onDragStart(
							toMsg(
								$sli$autotable$Autotable$DragStart(c.key))),
							$sli$autotable$Autotable$onDragEnd(
							toMsg($sli$autotable$Autotable$DragEnd)),
							$sli$autotable$Autotable$onDragOver(
							toMsg(
								$sli$autotable$Autotable$DragOver(c.key))),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('sort-indicator')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(sorting)
								]))
						]));
			},
			model.columns);
...
var $sli$autotable$Autotable$viewPagination = function (model) {
	var numPages = (model.pageSize > 0) ? ((($elm$core$Array$length(model.data) / model.pageSize) | 0) + 1) : 1;
	var numberEls = $elm$core$Array$toList(
		A2(
			...
			function (n) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('autotable__pagination-page')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('autotable__pagination')
			]),
		numberEls);
};
var $sli$autotable$Autotable$view = F2(
	function (model, toMsg) {
		var indexes = A2(
			$elm$core$List$range,
			0,
			$elm$core$Array$length(model.data));
		var filteredIndexes = A3(
			$elm$core$List$foldl,
			F2(
				function (f, data) {
					var _v1 = A2($sli$autotable$Autotable$findColumn, model.columns, f.a);
					if (_v1.$ === 'Just') {
						var c = _v1.a;
						return A2(
							$elm$core$List$filter,
							function (d) {
								var _v2 = A2($elm$core$Array$get, d, model.data);
								if (_v2.$ === 'Just') {
									var r = _v2.a;
									return A2(c.filter, r, f.b);
								} else {
									return false;
								}
							},
			...
			indexes,
			model.filters);
		var sortedIndexes = A3(
			$elm$core$List$foldl,
			F2(
				function (s, data) {
					var dir = s.b;
					var _v0 = A2($sli$autotable$Autotable$findColumn, model.columns, s.a);
					if (_v0.$ === 'Just') {
						var c = _v0.a;
						return A2(
							$sli$autotable$Autotable$setOrder,
							dir,
							A2(
								$elm$core$List$sortWith,
								A2($sli$autotable$Autotable$sorter, c.sort, model.data),
								data));
					} else {
						return data;
					}
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('autotable')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('bg-gray-900 text-white')
								]),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$tr,
									_List_Nil,
									A2($sli$autotable$Autotable$viewHeaderCells, model, toMsg)),
									A2(
									$elm$html$Html$tr,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('filter-inputs')
										]),
									A2($sli$autotable$Autotable$viewFilterCells, model, toMsg))
								])),
							A2(
							$elm$html$Html$tbody,
							_List_Nil,
							A3($sli$autotable$Autotable$viewBodyRows, model, sortedIndexes, toMsg))
						])),
					$sli$autotable$Autotable$viewPagination(model)
				]));
	});
var $sli$autotable$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$sli$autotable$PageCss$pageCss,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2($sli$autotable$Autotable$view, model.tableState, $sli$autotable$Main$TableMsg)
					]))
			]));
};
var $sli$autotable$Main$main = $elm$browser$Browser$element(
	{init: $sli$autotable$Main$init, subscriptions: $sli$autotable$Main$subscriptions, update: $sli$autotable$Main$update, view: $sli$autotable$Main$view});
_Platform_export({'Main':{'init':$sli$autotable$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"Edit":["String.String","Basics.Int","String.String"],"TableMsg":["Autotable.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Autotable.Msg":{"args":[],"tags":{"Sort":["String.String"],"Filter":["String.String","String.String"],"DragStart":["String.String"],"DragEnd":[],"DragOver":["String.String"],"Drop":[],"ToggleEdit":["Basics.Int"],"Edit":["String.String","Basics.Int","String.String"],"NextPage":[],"PrevPage":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
